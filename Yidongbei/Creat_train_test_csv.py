...
if __name__=='__main__':
    #step2生成训练集图片的文件夹地址
    train_img_dir = r'D:\Study\competition_lerning\Yidongbei\Data_version\training\img_labeled'
    #生成的训练集csv文件的保存地址
    train_save_dir = r'D:\Study\competition_lerning\Yidongbei\Data_version\training\total_train.csv'
