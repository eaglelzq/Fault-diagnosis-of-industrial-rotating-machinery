...
if __name__=='__main__':
    ...
    #生成的没标签的训练集图片保存的文件夹
    unlabeled_save_root = r'D:\Study\competition_lerning\Yidongbei\Data_version\training\img_unlabeled'
    generate_unlabel_img(unlabeled_data_files,unlabeled_save_root)
    # Step1生成的训练集的csv文件地址
    train_csv_file = r'D:\Study\competition_lerning\Yidongbei\trian.csv'
    #生成的有标签的训练集图片的保存文件夹
    train_save_root = r'D:\Study\competition_lerning\Yidongbei\Data_version\training\img_labeled'
